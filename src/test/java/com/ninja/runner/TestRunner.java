...
@CucumberOptions(
        ...
        glue = "com/ninja", // select step defination path from parent directory
        plugin = {"pretty",
...
public class TestRunner {
    ...
    public static void setUp() {
        ...
        String reportConfigPath = projectPath + "/src/test/java/resources/extentreport";
